...
import view.V_Authentification;
import view.V_RecherchePraticien;
import view.V_Frame;
import view.V_FicheMedicament;
import view.V_Menu;
import view.includes.V_Footer;
import view.includes.V_Header;
import view.V_FichePraticien;
import view.V_FicheVisiteur;
import view.V_ConsultationRapport;
import view.V_CreerRapport;
import view.V_RechercheVisiteur;
...
public class View_Controller {
	...
	private static void AuthentificationView(){
		FA.setHeader(new V_Header("Authentification"));
		FA.header_content();
