...
public class V_Authentification extends JPanel {
	...
	public void ndc_zone(){
		...
		ndc_entry = new JTextField("swiss");
	...
	public void mdp_zone(){
		...
		mdp_entry = new JPasswordField("1111-11-11");
	...
	public void logo_zone(){
		...
		logo_gsb.setBounds(328, -17, 100, 85);
		logo_gsb.setFont(new Font("Tahoma", Font.PLAIN, 5));
		logo_gsb.setBackground(Color.DARK_GRAY);
		logo_gsb.setIcon(new ImageIcon(V_Authentification.class.getResource("/view/img/logo2.png")));
	...
	/** Vérifie si il existe une correspondance au duo ndc/mdp dans la BDD via la methode check de la classe DAO_Visiteur **/
	private void logged(){
