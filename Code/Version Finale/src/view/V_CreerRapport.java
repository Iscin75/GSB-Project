...
import modele.DAO_Praticien;
import modele.DAO_Rapport;
import modele.DAO_Visiteur;
...
public class V_CreerRapport extends JPanel {
	...
	/** Constructeur de la classe - Initialise l'interface de création de rapport **/
	...
	/** Zone de selection du praticien visité **/
	...
	/** Zone d'écriture du bilan de la visite **/
	...
	/** Zone de saisie des différents médicaments offerts (JTable + Boutons d'ajout de lignes) **/
	public void echantillon_zone(){
		...
		// MODEL
				...
				AddRow.setBounds(380, 265, 88, 25);
				add(AddRow);
				...
				delRow.setFont(new Font("Tahoma", Font.PLAIN, 11));
				delRow.setBounds(380, 295, 88, 25);
				add(delRow);
	...
	/** /** Zone contenant les actions des différents boutons de la vue (Hors Echantillons) **/
		...
		btnSave.addActionListener(new ActionListener(){
			 public void actionPerformed(ActionEvent e) {
				 	// Count pour savoir combien de fois la boucle for va inserer de medicament
	               	...
	               	//Récupération de l'id de la session actuelle
	               	...
	               	if(!bilan.equals("") && !motif.equals("") && comboBox.getSelectedIndex() != -1){
	 	               ...
	 	               // On lance l'execution de la requette sql qui insert le rapport
		               	try {
							...
							JOptionPane.showMessageDialog(btnSave,"Le rapport a été ajouter avec succès");
		               	...
		               	// Boucle qui récupére tout les medicaments ajouté et les qqt
