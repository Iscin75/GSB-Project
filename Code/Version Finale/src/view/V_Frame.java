...
public class V_Frame extends JFrame{
	...
	private void initialize() {
		try{
			this.setIconImage(Toolkit.getDefaultToolkit().getImage(V_Frame.class.getResource("/view/img/logo.png")));
	...
	/** Permet l'inclusion dynamique du haut de page dans les différentes vues **/
	...
	/** Permet l'inclusion dynamique du corps dans les différentes vues **/
	public void corps(){	
	...
	/** Permet l'inclusion dynamique du bas de page dans les différentes vues **/
	...
	/** Permet de repeindre les fenêtres a fin de permettre l'enchainement des vues **/
	public void remake(){
		corps();
		header_content();
		revalidate();
