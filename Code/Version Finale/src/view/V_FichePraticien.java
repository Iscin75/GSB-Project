...
public class V_FichePraticien extends JPanel {
	...
	/** Panel légende et informations praticien **/
	private JPanel panel_gauche = new JPanel();
	private JPanel panel_droite = new JPanel();
	
	/** Init. des zones contenant les infos des différentes fiches praticien **/
	...
	public void panel_zone(){
		...
		panel_droite.setBackground(SystemColor.inactiveCaption);
		panel_droite.setBounds(21, 50, 663, 298);
		...
		panel_gauche.setBounds(23, 0, 93, 303);
		panel_gauche.setBackground(new Color(66, 76, 88));
	...
	/** Zone d'affichage de l'ID du praticien (clé primaire) **/
	...
	/** Zone de param. des différents boutons de la vue **/
	public void action_zone(ArrayList<Praticien> fiche) {
		...
		/** Voir la fiche du praticien précedent **/
		...
		btnPrcdent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent p) {
				if(View_Controller.row-1 > 0){
					...
					JOptionPane.showMessageDialog(panel_droite,"Aucun autre résultat. ");
				}
			}
		});
